...
class FormSubmissionsController extends Controller
{
		...
		public function contact(Request $request) {
			...
			$request->session()->flash('newContactAlertMessage', 'Your Contact Request was received. One of our representatives will contact you soon. A copy was sent to your mail.');

			// notifier, goes to admin
			$mail = \Mail::to(config('stir.notifier_to'));
			if (config('stir.notifier_cc')) {
				$mail->bcc(config('stir.notifier_cc'));
			}
